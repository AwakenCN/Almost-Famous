...
import com.liema.common.resources.BattleRankConf;
...
import com.liema.game.role.mongo.RoleDao;
...
//                    if (item.getCode() == AttrCode.SELF.value) {
//                        // 掉落组
//                        distributeAwardToActor(role, holdItems);
//                    }
                }
                return true;
            } catch (Exception e) {
